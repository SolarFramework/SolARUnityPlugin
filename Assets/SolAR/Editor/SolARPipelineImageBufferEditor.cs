...
namespace SolAR
{
    [CustomEditor(typeof(SolARPipelineImageBuffer), true)]
    public class SolARPipelineImageBufferEditor : Editor
    {
#pragma warning disable IDE1006 // Styles d'affectation de noms
        new SolARPipelineImageBuffer target { get { return (SolARPipelineImageBuffer)base.target; } }
