...
public class IMarker2DSquaredBinary : IMarker2DSquared {
  ...
  public virtual SquaredBinaryPattern getPattern() {
    global::System.IntPtr cPtr = solar_api_input_filesPINVOKE.IMarker2DSquaredBinary_getPattern(swigCPtr);
    SquaredBinaryPattern ret = (cPtr == global::System.IntPtr.Zero) ? null : new SquaredBinaryPattern(cPtr, true);
