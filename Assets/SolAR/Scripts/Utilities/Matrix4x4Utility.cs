...
namespace SolAR.Utilities
{
    ...
    {
        public static Vector3 GetRight(this Matrix4x4 m) => m.GetColumn(0);
        public static Vector3 GetUp(this Matrix4x4 m) => m.GetColumn(1);
        public static Vector3 GetForward(this Matrix4x4 m) => m.GetColumn(2);

        public static Vector3 GetPosition(this Matrix4x4 m) => m.GetColumn(3);
        public static Quaternion GetRotation(this Matrix4x4 m) => Quaternion.LookRotation(GetForward(m), GetUp(m));
        public static Vector3 GetScale(this Matrix4x4 m) => new Vector3(GetRight(m).magnitude, GetUp(m).magnitude, GetForward(m).magnitude);
