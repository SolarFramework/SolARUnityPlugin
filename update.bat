...
xcopy "%REMAKENROOT%\packages\SolARBuild\%compiler%\SolARModuleARF\0.7.0\lib\x86_64\shared\%mode%\SolARModuleARF.dll" .\Assets\Plugins\
...
xcopy "%REMAKENROOT%\packages\SolARBuild\%compiler%\PipelineRelocARF\0.7.0\lib\x86_64\shared\%mode%\PipelineRelocARF.dll" .\Assets\Plugins\
